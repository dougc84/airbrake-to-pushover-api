...
Written in completion by Doug Clark (Github: dougc84).  Distributed under GPLv3 license.  It is requested that, if this application is distributed, this paragraph is kept intact, but may be appended to.
